    ...
    (function (App) {
        var Application = (function () {
            ...
            Object.defineProperty(Application, "$inject", {
                get: function () {
                    return [
                        ...
                        "$location",
                        "$ionicHistory",
                        App.Services.Plugins.ID,
                        App.Services.Utilities.ID,
                        App.Services.UiHelper.ID,
                        App.Services.Configuration.ID,
                        App.Services.Logger.ID
                    ];
                },
                enumerable: true,
                configurable: true
            ...
            Application.prototype.device_menuButton = function () {
                this.$rootScope.$broadcast(App.Constants.Events.APP_MENU_BUTTON);
            };
            ...
            Application.prototype.registerDialogs = function (ngModule) {
                ...
                _.each(App.Controllers, function (Controller) {
                    if (Controller === App.Controllers.BaseDialogController) {
                        return;
                    }
                    if (_this.Utilities.derivesFrom(Controller, App.Controllers.BaseDialogController)) {
        ...
        var RouteConfig = (function () {
            ...
            RouteConfig.setupRoutes = function ($stateProvider, $urlRouterProvider) {
                $stateProvider.state("app", {
                    ...
                    controller: App.Controllers.RootController.ID
                });
                ...
                $stateProvider.state("app.activity-manager", {
                    url: "/activity-manager",
                    views: {
                        "root-view": {
                            templateUrl: "Views/ActivityManager/Activity-Setting-List/ActivityManager.html",
                            controller: App.Controllers.ActivitySettingsListController.ID
                        }
                    }
                });
                $stateProvider.state("app.upload-activity", {
                    url: "/upload-activity",
                    views: {
                        "root-view": {
                            templateUrl: "Views/ActivityManager/Upload-Activity/UploadActivity.html",
                            controller: App.Controllers.UploadActivityController.ID
                        }
                    }
                });
                $stateProvider.state("app.view-activity", {
                    url: "/view-activity/:viewActivityType",
                    views: {
                        "root-view": {
                            templateUrl: "Views/ActivityManager/View-Activity/ViewActivity.html",
                            controller: App.Controllers.ViewActivityController.ID
                        }
                    }
                });
                $stateProvider.state("app.category", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.CategoryController.ID
                        }
                    }
                });
                $stateProvider.state("app.onboarding-splash", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.OnboardingSplashController.ID
                        }
                    }
                });
                $stateProvider.state("app.onboarding-register", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.OnboardingRegisterController.ID
                        }
                    }
                });
                $stateProvider.state("app.onboarding-share", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.OnboardingShareController.ID
                        }
                    }
                });
                $stateProvider.state("app.settings-list", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.SettingsListController.ID
                        }
                    }
                });
                $stateProvider.state("app.cloud-sync", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.CloudSyncController.ID
                        }
                    }
                });
                $stateProvider.state("app.configure-pin", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.ConfigurePinController.ID
                        }
                    }
                });
                $stateProvider.state("app.developer", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.DeveloperController.ID
                        }
                    }
                });
                $stateProvider.state("app.logs", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.LogsListController.ID
                        }
                    }
                });
                $stateProvider.state("app.log-entry", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.LogEntryController.ID
                        }
                    }
                });
                $stateProvider.state("app.about", {
                    ...
                    views: {
                        "root-view": {
                            ...
                            controller: App.Controllers.AboutController.ID
                        }
                    }
                });
    ...
    (function (App) {
        ...
        (function (Boot2) {
            ...
            function boot() {
                ...
                App.BootHelper.registerServices(ngModule);
                App.BootHelper.registerDirectives(ngModule);
                App.BootHelper.registerFilters(ngModule);
                App.BootHelper.registerControllers(ngModule);
                ngModule.service(App.Application.ID, App.Application);
                var $inject_angular_initialize = [
                    "$ionicPlatform",
                    App.Application.ID,
                    App.Services.Configuration.ID,
                    App.Services.MockHttpApis.ID,
                    angular_initialize
                ];
            ...
            function angular_configure($stateProvider, $urlRouterProvider, $provide, $httpProvider, $compileProvider, $ionicConfigProvider) {
                ...
                $httpProvider.interceptors.push(App.Services.HttpInterceptor.ID);
                $ionicConfigProvider.views.swipeBackEnabled(true);
                App.RouteConfig.setupRoutes($stateProvider, $urlRouterProvider);
                if (localStorage.getItem("ENABLE_MOCK_HTTP_CALLS") === "true") {
                    App.Services.MockHttpApis.setupMockHttpDelay($provide);
                }
            }
            ;
        })(Boot2 = App.Boot2 || (App.Boot2 = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
var Snappy;
(function (Snappy) {
    ...
    (function (App) {
        ...
        (function (BootHelper) {
            ...
            function registerDirectives(ngModule) {
                _.each(App.Directives, function (Directive) {
                    if (Directive.ID) {
        ...
        })(BootHelper = App.BootHelper || (App.BootHelper = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
var Snappy;
(function (Snappy) {
    ...
    (function (App) {
        ...
        (function (Models) {
            var Feature = (function () {
                function Feature(name, href, state, icon) {
                    this.name = name;
                    this.href = href;
                    this.state = state;
                    this.icon = icon;
    ...
    (function (App) {
        ...
        (function (Services) {
            var Configuration = (function () {
                ...
                Object.defineProperty(Configuration.prototype, "isDebug", {
                    get: function () {
                ...
                Object.defineProperty(Configuration.prototype, "buildTimestamp", {
                    get: function () {
                ...
                Object.defineProperty(Configuration.prototype, "commitShortSha", {
                    get: function () {
                ...
                Object.defineProperty(Configuration.prototype, "values", {
                    get: function () {
                ...
                HttpInterceptor.prototype.responseError = function (responseOrError) {
                    ...
                    if (responseOrError instanceof Error) {
                        ...
                        if (httpResponse.status === 401) {
                            this.$rootScope.$broadcast(App.Constants.Events.HTTP_UNAUTHORIZED, httpResponse);
                        }
                        else if (httpResponse.status === 403) {
                            this.$rootScope.$broadcast(App.Constants.Events.HTTP_FORBIDDEN, httpResponse);
                        }
                        else if (httpResponse.status === 404) {
                            this.$rootScope.$broadcast(App.Constants.Events.HTTP_NOT_FOUND, httpResponse);
                        }
                        else if (httpResponse.status === 0) {
                            this.$rootScope.$broadcast(App.Constants.Events.HTTP_UNKNOWN_ERROR, httpResponse);
                        }
                        else {
                            this.$rootScope.$broadcast(App.Constants.Events.HTTP_ERROR, httpResponse);
                        }
                    }
                    return this.$q.reject(responseOrError);
                };
        ...
        (function (Services) {
            var Logger = (function () {
                ...
                Logger.prototype.trace = function (tagPrefix, tag, message, metadata) {
                    this.log(App.Models.LogLevel.TRACE, tagPrefix, tag, message, metadata);
                };
                Logger.prototype.debug = function (tagPrefix, tag, message, metadata) {
                    this.log(App.Models.LogLevel.DEBUG, tagPrefix, tag, message, metadata);
                };
                Logger.prototype.info = function (tagPrefix, tag, message, metadata) {
                    this.log(App.Models.LogLevel.INFO, tagPrefix, tag, message, metadata);
                };
                Logger.prototype.warn = function (tagPrefix, tag, message, metadata) {
                    this.log(App.Models.LogLevel.WARN, tagPrefix, tag, message, metadata);
                };
                Logger.prototype.error = function (tagPrefix, tag, message, metadata) {
                    this.log(App.Models.LogLevel.ERROR, tagPrefix, tag, message, metadata);
                };
                Logger.prototype.fatal = function (tagPrefix, tag, message, metadata) {
                    this.log(App.Models.LogLevel.FATAL, tagPrefix, tag, message, metadata);
                };
                ...
                Logger.prototype.getIconForLevel = function (level) {
                    ...
                    switch (level) {
                        case App.Models.LogLevel.TRACE:
                            return "ion-code-working";
                        case App.Models.LogLevel.DEBUG:
                            return "ion-bug";
                        case App.Models.LogLevel.INFO:
                            return "ion-information-circled";
                        case App.Models.LogLevel.WARN:
                            return "ion-alert-circled";
                        case App.Models.LogLevel.ERROR:
                            return "ion-alert";
                        case App.Models.LogLevel.FATAL:
                            return "ion-nuclear";
                        default:
                            return "ion-alert";
                    }
                ...
                Logger.prototype.log = function (logLevel, tagPrefix, tag, message, metadata) {
                    if (logLevel == null) {
                        logLevel = App.Models.LogLevel.DEBUG;
                    }
                    if (!tag) {
                        tag = "[No Tag]";
                    }
                    ...
                    var logEntry = new App.Models.LogEntry();
        ...
        (function (Services) {
            var MockPlatformApis = (function () {
                ...
                MockPlatformApis.prototype.notification_alert = function (message, alertCallback, title, buttonName) {
                    var buttons = [];
                    title = title || "Alert";
                    buttonName = buttonName || App.Constants.Buttons.OK;
                ...
                MockPlatformApis.prototype.notification_confirm = function (message, confirmCallback, title, buttonLabels) {
                    var buttons = [];
                    title = title || "Confirm";
                    buttonLabels = buttonLabels || [App.Constants.Buttons.Yes, App.Constants.Buttons.No];
                ...
                MockPlatformApis.prototype.notification_prompt = function (message, promptCallback, title, buttonLabels, defaultText) {
                    ...
                    title = title || "Prompt";
                    buttonLabels = buttonLabels || [App.Constants.Buttons.OK, App.Constants.Buttons.Cancel];
                    buttonLabels.forEach(function (value, index) {
                        buttons.push({
                            text: value,
                            onTap: function (e) {
            ...
            var UiHelper = (function () {
                ...
                UiHelper.prototype.prompt = function (message, title, buttonLabels, defaultText) {
                    ...
                    callback = function (promptResult) {
                        ...
                        promiseResult = new App.Models.KeyValuePair(buttonText, promptResult.input1);
                ...
                UiHelper.prototype.showDialog = function (dialogId, options) {
                    ...
                    if (!template) {
                        ...
                        this.$q.reject(App.Constants.DIALOG_ID_NOT_REGISTERED);
                        return q.promise;
                    }
                ...
                UiHelper.prototype.showPinEntryAfterResume = function () {
                    ...
                    if (this.isPinEntryOpen) {
                        q.reject(App.Constants.DIALOG_ALREADY_OPEN);
                        return q.promise;
                    }
                    if (this.Preferences.pin && this.Configuration.lastPausedAt != null && this.Configuration.lastPausedAt.isValid()) {
                        ...
                        if (resumedAt.diff(this.Configuration.lastPausedAt, "minutes") > this.Configuration.requirePinThreshold) {
                            model = new App.Models.PinEntryDialogModel("PIN Required", this.Preferences.pin, false);
                            options = new App.Models.DialogOptions(model);
                            options.backdropClickToClose = false;
                            options.hardwareBackButtonClose = false;
                            options.showBackground = false;
                            this.showDialog(App.Controllers.PinEntryController.ID, options).then(function (result) {
                                q.resolve();
                            });
                        }
                        else {
    ...
    (function (App) {
        ...
        (function (Services) {
            var Utilities = (function () {
                ...
                Object.defineProperty(Utilities.prototype, "viewport", {
                    get: function () {
                        var e = window;
                        var a = "inner";
                ...
                Object.defineProperty(Utilities.prototype, "categories", {
                    get: function () {
                        var categories = [
                            new App.Models.Category("Category 1", "#/app/category/1", "ios-pricetags-outline", 0),
                            new App.Models.Category("Category 2", "#/app/category/2", "ios-pricetags-outline", 1),
                            new App.Models.Category("Category 3", "#/app/category/3", "ios-pricetags-outline", 2),
                            new App.Models.Category("Category 4", "#/app/category/4", "ios-pricetags-outline", 3)
                        ];
                ...
                Object.defineProperty(Utilities.prototype, "vendorSideMenuOptions", {
                    get: function () {
                        var features = [
                            new App.Models.Feature("Activity Manager", "#/app/activity-manager", "app.activity-manager", ""),
                            new App.Models.Feature("My Finance", "#/app/my-finance", "app.my-finance", "")
                        ];
                        return features;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(Utilities.prototype, "activityManagerOptions", {
                    get: function () {
                        var activityManagerOptions = [
                            new App.Models.Feature("Upload Activty", "#/app/upload-activity", "app.upload-activity", ""),
                            new App.Models.Feature("View Booked Activities", "#/app/view-activity/bookedActivity", "app.view-activity", ""),
                            new App.Models.Feature("View Ongoing Activities", "#/app/view-activity/ongoingActivity", "app.view-activity", ""),
                            new App.Models.Feature("View Completed Activities", "#/app/view-activity/completedActivity", "app.view-activity", "")
                        ];
                        return activityManagerOptions;
                    },
                    enumerable: true,
                    configurable: true
                });
...
(function (Snappy) {
    ...
    (function (App) {
        var Controllers;
        (function (Controllers) {
            var ActivitySettingsListController = (function (_super) {
                __extends(ActivitySettingsListController, _super);
                function ActivitySettingsListController($scope, Utilities) {
                    _super.call(this, $scope, App.ViewModels.ActivitySettingsListViewModel);
                    this.Utilities = Utilities;
                }
                Object.defineProperty(ActivitySettingsListController, "$inject", {
                    get: function () {
                        return [
                            "$scope",
                            App.Services.Utilities.ID
                ...
                ActivitySettingsListController.prototype.view_loaded = function (event, eventArgs) {
                ...
                ActivitySettingsListController.ID = "ActivitySettingsListController";
                return ActivitySettingsListController;
            })(Controllers.BaseController);
            Controllers.ActivitySettingsListController = ActivitySettingsListController;
        })(Controllers = App.Controllers || (App.Controllers = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
var Snappy;
(function (Snappy) {
    ...
    (function (App) {
        var ViewModels;
        (function (ViewModels) {
            var ActivitySettingsListViewModel = (function () {
                function ActivitySettingsListViewModel() {
                }
                return ActivitySettingsListViewModel;
            })();
            ViewModels.ActivitySettingsListViewModel = ActivitySettingsListViewModel;
        })(ViewModels = App.ViewModels || (App.ViewModels = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
var Snappy;
(function (Snappy) {
    ...
    (function (App) {
        var Controllers;
        (function (Controllers) {
            var UploadActivityController = (function (_super) {
                __extends(UploadActivityController, _super);
                function UploadActivityController($scope, Utilities) {
                    _super.call(this, $scope, App.ViewModels.UploadActivityViewModel);
                    this.Utilities = Utilities;
                }
                Object.defineProperty(UploadActivityController, "$inject", {
                    get: function () {
                        return [
                            "$scope",
                            App.Services.Utilities.ID
                ...
                UploadActivityController.prototype.view_loaded = function (event, eventArgs) {
                    _super.prototype.view_loaded.call(this, event, eventArgs);
                };
                UploadActivityController.ID = "UploadActivityController";
                return UploadActivityController;
            })(Controllers.BaseController);
            Controllers.UploadActivityController = UploadActivityController;
        })(Controllers = App.Controllers || (App.Controllers = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
/**
...
(function (Snappy) {
    ...
    (function (App) {
        var ViewModels;
        (function (ViewModels) {
            var UploadActivityViewModel = (function () {
                function UploadActivityViewModel() {
                }
                return UploadActivityViewModel;
            })();
            ViewModels.UploadActivityViewModel = UploadActivityViewModel;
        })(ViewModels = App.ViewModels || (App.ViewModels = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
var Snappy;
(function (Snappy) {
    ...
    (function (App) {
        var Controllers;
        (function (Controllers) {
            var ViewActivityController = (function (_super) {
                __extends(ViewActivityController, _super);
                function ViewActivityController($scope, $stateParams, Utilities) {
                    _super.call(this, $scope, App.ViewModels.UploadActivityViewModel);
                    this.$stateParams = $stateParams;
                    this.Utilities = Utilities;
                }
                Object.defineProperty(ViewActivityController, "$inject", {
                    get: function () {
                        return [
                            "$scope",
                            "$stateParams",
                ...
                ViewActivityController.prototype.view_loaded = function (event, eventArgs) {
                    _super.prototype.view_loaded.call(this, event, eventArgs);
                    this.viewModel.viewType = this.$stateParams.viewActivityType;
                };
                ViewActivityController.ID = "ViewActivityController";
                return ViewActivityController;
            })(Controllers.BaseController);
            Controllers.ViewActivityController = ViewActivityController;
        })(Controllers = App.Controllers || (App.Controllers = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
/**
...
(function (Snappy) {
    ...
    (function (App) {
        var ViewModels;
        (function (ViewModels) {
            var ViewActivityViewModel = (function () {
                function ViewActivityViewModel() {
                }
                return ViewActivityViewModel;
            })();
            ViewModels.ViewActivityViewModel = ViewActivityViewModel;
        })(ViewModels = App.ViewModels || (App.ViewModels = {}));
    })(App = Snappy.App || (Snappy.App = {}));
})(Snappy || (Snappy = {}));
var Snappy;
        ...
        (function (Controllers) {
            var CategoryController = (function (_super) {
                ...
                function CategoryController($scope, $stateParams) {
                    _super.call(this, $scope, App.ViewModels.CategoryViewModel);
                    this.$stateParams = $stateParams;
                }
        ...
        (function (Controllers) {
            var PinEntryController = (function (_super) {
                ...
                function PinEntryController($scope, Plugins, Utilities, Preferences) {
                    _super.call(this, $scope, App.ViewModels.PinEntryViewModel, PinEntryController.ID);
                    this.Plugins = Plugins;
                    this.Utilities = Utilities;
                    this.Preferences = Preferences;
                }
                ...
                PinEntryController.prototype.validatePin = function () {
                    if (this.viewModel.pinToMatch) {
                        if (this.viewModel.pin === this.viewModel.pinToMatch) {
                            this.close(new App.Models.PinEntryDialogResultModel(true, false, this.viewModel.pin));
                        }
                        else {
                            this.viewModel.pin = "";
                        ...
                        this.close(new App.Models.PinEntryDialogResultModel(null, false, this.viewModel.pin));
                    }
                };
                ...
                PinEntryController.prototype.back_click = function () {
                    this.close(new App.Models.PinEntryDialogResultModel(null, true, null));
                };
        ...
        (function (Controllers) {
            var ReorderCategoriesController = (function (_super) {
                ...
                function ReorderCategoriesController($scope, Utilities, Preferences, UiHelper) {
                    _super.call(this, $scope, App.ViewModels.ReorderCategoriesViewModel, ReorderCategoriesController.ID);
                    this.Utilities = Utilities;
                    this.Preferences = Preferences;
                    this.UiHelper = UiHelper;
                }
        ...
        (function (Controllers) {
            var OnboardingRegisterController = (function (_super) {
                ...
                function OnboardingRegisterController($scope, $location, $ionicHistory, Plugins, Utilities, UiHelper, Configuration) {
                    _super.call(this, $scope, App.ViewModels.OnboardingRegisterViewModel);
                    this.$location = $location;
                    this.$ionicHistory = $ionicHistory;
                    this.Plugins = Plugins;
                    this.Utilities = Utilities;
        ...
        (function (Controllers) {
            var OnboardingShareController = (function (_super) {
                ...
                function OnboardingShareController($scope, $location, $ionicHistory, Utilities, UiHelper, Plugins, Configuration) {
                    _super.call(this, $scope, App.ViewModels.EmptyViewModel);
                    this.$location = $location;
                    this.$ionicHistory = $ionicHistory;
                    this.Utilities = Utilities;
                    this.UiHelper = UiHelper;
        ...
        (function (Controllers) {
            var RootController = (function (_super) {
                ...
                function RootController($scope, $location, $http, Plugins, Utilities, UiHelper, Preferences) {
                    _super.call(this, $scope, App.ViewModels.RootViewModel);
                    this.$location = $location;
                    this.$http = $http;
                    this.Plugins = Plugins;
                    this.Utilities = Utilities;
                ...
                RootController.prototype.view_loaded = function (event, eventArgs) {
                    ...
                    this.scope.$on(App.Constants.Events.HTTP_UNAUTHORIZED, _.bind(this.http_unauthorized, this));
                    this.scope.$on(App.Constants.Events.HTTP_FORBIDDEN, _.bind(this.http_forbidden, this));
                    this.scope.$on(App.Constants.Events.HTTP_NOT_FOUND, _.bind(this.http_notFound, this));
                    this.scope.$on(App.Constants.Events.HTTP_UNKNOWN_ERROR, _.bind(this.http_unknownError, this));
                    this.scope.$on(App.Constants.Events.HTTP_ERROR, _.bind(this.http_error, this));
                    this.viewModel.categories = this.Utilities.categories;
                    this.viewModel.features = this.Utilities.vendorSideMenuOptions;
                };
        ...
        (function (Controllers) {
            var AboutController = (function (_super) {
                ...
                function AboutController($scope, $ionicHistory, Utilities, Configuration, Plugins) {
                    _super.call(this, $scope, App.ViewModels.AboutViewModel);
                    this.$ionicHistory = $ionicHistory;
                    this.Utilities = Utilities;
                    this.Configuration = Configuration;
                    this.Plugins = Plugins;
        ...
        (function (Controllers) {
            var CloudSyncController = (function (_super) {
                ...
                function CloudSyncController($scope, $ionicHistory) {
                    _super.call(this, $scope, App.ViewModels.CloudSyncViewModel);
                    this.$ionicHistory = $ionicHistory;
        ...
        (function (Controllers) {
            var ConfigurePinController = (function (_super) {
                ...
                function ConfigurePinController($scope, Plugins, UiHelper, Preferences) {
                    _super.call(this, $scope, App.ViewModels.ConfigurePinViewModel);
                    this.Plugins = Plugins;
                    this.UiHelper = UiHelper;
                    this.Preferences = Preferences;
                }
                ...
                ConfigurePinController.prototype.setPin_click = function () {
                    var _this = this;
                    var options, model;
                    model = new App.Models.PinEntryDialogModel("Enter a value for your new PIN", null, true);
                    options = new App.Models.DialogOptions(model);
                ...
                ConfigurePinController.prototype.changePin_click = function () {
                    var _this = this;
                    var options, model;
                    model = new App.Models.PinEntryDialogModel("Enter your current PIN", this.Preferences.pin, true);
                    options = new App.Models.DialogOptions(model);
                    this.UiHelper.showDialog(Controllers.PinEntryController.ID, options).then(function (result1) {
                        if (result1.matches) {
    ...
    (function (App) {
        ...
        (function (Controllers) {
            var DeveloperController = (function (_super) {
                ...
                function DeveloperController($scope, $window, Plugins, Utilities, UiHelper, FileUtilities, Logger, Preferences, Configuration, MockPlatformApis) {
                    _super.call(this, $scope, App.ViewModels.DeveloperViewModel);
                    this.$window = $window;
                    this.Plugins = Plugins;
                    this.Utilities = Utilities;
                    this.UiHelper = UiHelper;
                ...
                Object.defineProperty(DeveloperController, "$inject", {
                    get: function () {
                        return [
                            ...
                            App.Services.Utilities.ID,
                            App.Services.UiHelper.ID,
                            App.Services.FileUtilities.ID,
                            App.Services.Logger.ID,
                            App.Services.Preferences.ID,
                            App.Services.Configuration.ID,
                            App.Services.MockPlatformApis.ID
                        ];
                    },
                    enumerable: true,
                    configurable: true
                ...
                DeveloperController.prototype.copyValue_click = function (value, name) {
                    var _this = this;
                    this.UiHelper.confirm("Copy " + name + " to clipboard?").then(function (result) {
                        if (result === App.Constants.Buttons.Yes) {
                            _this.Plugins.clipboard.copy(value);
                            _this.Plugins.toast.showShortBottom(name + " copied to clipboard.");
                        }
                    });
                };
                ...
                DeveloperController.prototype.apiUrl_click = function () {
                    ...
                    this.UiHelper.prompt(message, "API URL", null, this.Configuration.apiUrl).then(function (result) {
                        if (result.key === App.Constants.Buttons.Cancel) {
                            return;
                        }
                ...
                DeveloperController.prototype.setRequirePinThreshold_click = function () {
                    ...
                    this.UiHelper.prompt(message, "Require PIN Threshold", null, this.Configuration.requirePinThreshold.toString()).then(function (result) {
                        if (result.key !== App.Constants.Buttons.OK) {
                            return;
                        }
        ...
        (function (Controllers) {
            var LogEntryController = (function (_super) {
                ...
                function LogEntryController($scope, $stateParams, Logger, Plugins, Utilities, Configuration) {
                    _super.call(this, $scope, App.ViewModels.LogEntryViewModel);
                    this.$stateParams = $stateParams;
                    this.Logger = Logger;
                    this.Plugins = Plugins;
                    this.Utilities = Utilities;
                ...
                LogEntryController.prototype.email_click = function () {
                    var uri = this.Utilities.format("mailto:{0}?subject={1} Error Log&body={2}", this.Configuration.values.authorEmail, this.Configuration.values.appName, JSON.stringify(this.viewModel.logEntry));
                    uri = encodeURI(uri);
        ...
        (function (Controllers) {
            var LogsListController = (function (_super) {
                ...
                function LogsListController($scope, $ionicPopover, Logger, UiHelper) {
                    _super.call(this, $scope, App.ViewModels.LogsListViewModel);
                ...
                LogsListController.prototype.populateViewModel = function (logEntries) {
                    ...
                    logEntries.forEach(function (logEntry) {
                        ...
                        viewModel = new App.ViewModels.LogEntryViewModel();
        ...
        (function (Controllers) {
            var SettingsListController = (function (_super) {
                ...
                function SettingsListController($scope, Utilities, Configuration) {
                    _super.call(this, $scope, App.ViewModels.SettingsListViewModel);
                    this.Utilities = Utilities;
                    this.Configuration = Configuration;
                }
