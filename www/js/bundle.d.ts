declare namespace Snappy.App.Controllers {
...
declare namespace Snappy.App.Directives {
...
declare namespace Snappy.App.Constants {
    const DIALOG_ALREADY_OPEN: string;
    const DIALOG_ID_NOT_REGISTERED: string;
}
declare namespace Snappy.App.Constants.Buttons {
    const Yes: string;
    const No: string;
    const OK: string;
    const Cancel: string;
}
declare namespace Snappy.App.Constants.Events {
...
declare namespace Snappy.App.Filters {
    class ThousandsFilter {
        static ID: string;
        static filter(input: number): string;
    }
}
declare namespace Snappy.App.Boot2 {
    function boot(): void;
}
declare namespace Snappy.App.BootHelper {
...
declare namespace Snappy.App.Models {
    class DialogOptions {
        dialogData: any;
...
declare namespace Snappy.App.ViewModels {
...
declare namespace Snappy.App.Services {
    class Configuration {
        private buildVars;
        static ID: string;
        static $inject: string[];
        constructor(buildVars: Interfaces.BuildVars);
...
declare namespace Snappy.App.Services {
    class MockPlatformApis {
        ...
        getToastPlugin(): ToastPlugin.ToastPluginStatic;
        getPushNotificationPlugin(): PushNotification;
        getClipboardPlugin(): ClipboardPlugin.ClipboardPluginStatic;
        getClipboardPluginForWindows(): ClipboardPlugin.ClipboardPluginStatic;
        getClipboardPluginForChromeExtension(): ClipboardPlugin.ClipboardPluginStatic;
...
declare namespace Snappy.App.Services {
    class Utilities {
        ...
        vendorSideMenuOptions: Models.Feature[];
        activityManagerOptions: Models.Feature[];
        defaultCategory: Models.Category;
    }
}
declare namespace Snappy.App.Controllers {
    class ActivitySettingsListController extends BaseController<ViewModels.ActivitySettingsListViewModel> {
        private Utilities;
        static ID: string;
        static $inject: string[];
        constructor($scope: ng.IScope, Utilities: Services.Utilities);
        protected view_loaded(event?: ng.IAngularEvent, eventArgs?: Ionic.IViewEventArguments): void;
    }
}
declare namespace Snappy.App.ViewModels {
    class ActivitySettingsListViewModel {
        activityManagerOptions: Models.Feature[];
    }
}
declare namespace Snappy.App.Controllers {
    class UploadActivityController extends BaseController<ViewModels.UploadActivityViewModel> {
        private Utilities;
        static ID: string;
        static $inject: string[];
        constructor($scope: ng.IScope, Utilities: Services.Utilities);
...
declare namespace Snappy.App.Controllers {
    interface IViewActivityStateParams {
        viewActivityType: number;
    }
    class ViewActivityController extends BaseController<ViewModels.ViewActivityViewModel> {
        private $stateParams;
        private Utilities;
        static ID: string;
        static $inject: string[];
        constructor($scope: ng.IScope, $stateParams: IViewActivityStateParams, Utilities: Services.Utilities);
        protected view_loaded(event?: ng.IAngularEvent, eventArgs?: Ionic.IViewEventArguments): void;
    }
}
declare namespace Snappy.App.ViewModels {
...
declare namespace Snappy.App.Controllers {
    class DeveloperController extends BaseController<ViewModels.DeveloperViewModel> {
        ...
        static ID: string;
        static $inject: string[];
        constructor($scope: ng.IScope, $window: ng.IWindowService, Plugins: Services.Plugins, Utilities: Services.Utilities, UiHelper: Services.UiHelper, FileUtilities: Services.FileUtilities, Logger: Services.Logger, Preferences: Services.Preferences, Configuration: Services.Configuration, MockPlatformApis: Services.MockPlatformApis);
        protected view_beforeEnter(event?: ng.IAngularEvent, eventArgs?: Ionic.IViewEventArguments): void;
