            ...
            $stateProvider.state("app.activity-manager", {
                ...
                views: {
                    "root-view": {
                        ...
                        controller: Controllers.ActivitySettingsListController.ID
                    }
                }
            });
            ...
            $stateProvider.state("app.upload-activity", {
                ...
                views: {
                    "root-view": {
                        ...
                        controller: Controllers.UploadActivityController.ID
                    }
                }
            });
            ...
            $stateProvider.state("app.view-activity", {
                ...
                views: {
                    "root-view": {
                        ...
                        controller: Controllers.ViewActivityController.ID
                    }
                }
            });
