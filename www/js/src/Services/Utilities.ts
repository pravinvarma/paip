namespace Snappy.App.Services {
    ...
    export class Utilities {
        ...
        */
        ...
        public get vendorSideMenuOptions () : Models.Feature[]{
            var features = [
                new Models.Feature("Activity Manager","#/app/activity-manager","app.activity-manager",""),
                new Models.Feature("My Finance","#/app/my-finance","app.my-finance","")
            ];

            return features;
        }

        public  get activityManagerOptions() : Models.Feature[]{
            var activityManagerOptions = [
                new Models.Feature("Upload Activty","#/app/upload-activity","app.upload-activity",""),
                new Models.Feature("View Booked Activities","#/app/view-activity/bookedActivity","app.view-activity",""),
                new Models.Feature("View Ongoing Activities","#/app/view-activity/ongoingActivity","app.view-activity",""),
                new Models.Feature("View Completed Activities","#/app/view-activity/completedActivity","app.view-activity","")
            ];
